...
if lin:
    pyperclip.copy("https://www.linkedin.com/in/dhruvsanan01/")
...
if git:
    pyperclip.copy("https://github.com/dhruvsanan")
    st.success('Text copied successfully!')
...
email_prompt = """ You are an expert in creating professional emails
                ...
                create an email to founder explaining why are you a good fit for {jt} position. 
                ...
                make sure to follow the below email template
